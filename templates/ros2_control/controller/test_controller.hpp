...
class Testable$ClassName$ : public $package_name$::$ClassName$
{
  ...
  FRIEND_TEST($ClassName$Test, all_parameters_set);
...
protected:
  void SetUpController(bool set_parameters = true)
  {
    ...
    // TODO(anyone): Add command interfaces
    command_ifs.emplace_back(joint1_command_itf_);

    std::vector<hardware_interface::LoanedStateInterface> state_ifs;
    // TODO(anyone): Add state interfaces
    state_ifs.emplace_back(joint1_state_itf_);
  ...
  void subscribe_and_get_message(ControllerStateMsg & msg)
  {
...
protected:
  ...
  hardware_interface::StateInterface joint1_state_itf_{ joint_names_[0], interface_name_,
                                                        &joint_state_values_[0] };
  hardware_interface::CommandInterface joint1_command_itf_{ joint_names_[0], interface_name_,
...
public:
  ...
  static void TearDownTestCase()
  {
    $ClassName$Test::TearDownTestCase();
  }
